            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li>
                            <a class="active" href="#">Add Pembayaran</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="form-container">
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="bulan_dibayar" name="bulan_dibayar" required>
                    </div>
            
                    <div class="form-group">
                        <label for="tahun_dibayar">Tahun Dibayar:</label>
                        <input type="text" id="tahun_dibayar" name="tahun_dibayar" required>
                    </div>
            
                    <div class="form-group">
                        <label for="id_spp">ID SPP:</label>
                        <input type="text" id="id_spp" name="id_spp" required>
                    </div>
            
                    <div class="form-group">
                        <label for="jumlah_bayar">Jumlah Bayar:</label>
                        <input type="text" id="jumlah_bayar" name="jumlah_bayar" required>
                    </div>
