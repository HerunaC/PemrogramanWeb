...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_update = "UPDATE kelas SET nama_kelas = '$nama_kelas', jurusan = '$jurusan' WHERE id_kelas = '$id_kelas'";
            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li>
                            <a class="active" href="#">Edit Kelas</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="form-container">
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?id_kelas=' . $id_kelas; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nama_kelas" name="nama_kelas" value="<?php echo $row['nama_kelas']; ?>" required>
                    </div>
